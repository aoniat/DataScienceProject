...
wine_names <- read.table(file.choose("winequality.names"), sep=";", header=T)
...
```{r}
#GBM
#want to find a threshhold

#SPLINES

#RANDOM FOREST

#K-means? if the clusters are distinct
```


```{r}
#NLP tag of words (adjective of word)
#can otherwise create a list of all the possible adjectives you want
```
